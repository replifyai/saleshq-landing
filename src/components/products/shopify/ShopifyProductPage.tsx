    ...
    <div className="min-h-screen">
      ...
      <div className="mt-16 border-b border-border">
        <div className="mx-auto flex h-14 max-w-6xl items-center px-4 text-[13px] text-muted-foreground sm:px-6 lg:px-8">
          ...
          <span className="font-medium text-foreground">SalesHQ for Shopify</span>
        </div>
      </div>

      {/* Hero — split layout */}
      <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-20">
